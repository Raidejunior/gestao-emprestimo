...
export class ControladoraFuncionario {
    ...
    verificarPermissao() {
        ...
        if(funcionario != null && funcionario.permissao === Funcionario.PERMISSAO_GERENTE) { // caso o funcionario for um gerente, a opção de acesso ao relatório e de cadastro de funcionários é adicionada
