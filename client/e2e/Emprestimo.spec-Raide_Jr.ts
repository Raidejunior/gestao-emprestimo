...
test.describe('Fornecer valores para empréstimo ', () => {
    ...
    test('Fornecer valor maior que o limite do cliente', async({page}) => {
        await fornecerValores(page, '191.959.207-57', true, '100000000');
    });
...
test.describe('Realizar empréstimo ', () => {
    ...
    test('Realizar empréstimo de 44567 com 12 parcelas e 22% de juros', async({page}) => {
        await solicitarEmprestimo(page, '191.959.207-57', '44567', '12', '54.371,74', '44.567,00', 'Cliente 1');
    });

    test('Realizar empréstimo de 11122 com 6 parcelas e 10% de juros', async({page}) => {
        await solicitarEmprestimo(page, '123.456.789-10', '11122', '6', '12.234,20', '11.122,00', 'Cliente 2');
    });

    test('Realizar empréstimo de 33333 com 12 parcelas e 22% de juros', async({page}) => {
        await solicitarEmprestimo(page, '123.456.789-10', '33333', '12', '40.666,26', '33.333,00', 'Cliente 2');
    });
});